...
public class Drivetrain extends SubsystemBase {
  ...
  public void setChassisSpeeds(ChassisSpeeds chassisSpeeds, Trajectory.State currentState, Trajectory.State prevState) {
    ...
    Matrix<N2, N1> r =
        VecBuilder.fill(prevFeedforwardSpeeds.leftMetersPerSecond, prevFeedforwardSpeeds.rightMetersPerSecond);
    ...
    Matrix<N2, N1> nextR =
        VecBuilder.fill(
            currentFeedforwardSpeeds.leftMetersPerSecond, currentFeedforwardSpeeds.rightMetersPerSecond);
